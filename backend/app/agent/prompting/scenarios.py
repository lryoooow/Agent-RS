...
TOOL_FINAL_PROMPTS: dict[str, str] = {
    ...
    "segment_instances": "正在基于 SAM3 分割结果生成回答",
...
TOOL_REQUEST_LABELS: dict[str, str] = {
    ...
    "segment_instances": "请求调用 SAM3 开放词汇分割",
...
TOOL_READY_LABELS: dict[str, str] = {
    ...
    "segment_instances": "SAM3 分割结果已整理",
