...
DEFAULT_DATASET_DIR = PROJECT_ROOT / "tests" / "datasets" / "agent-rs"
DEFAULT_REPORT_ROOT = PROJECT_ROOT / "tests" / "reports" / "agent-rs"
...
def validate_cases(cases: list[dict[str, Any]]) -> list[str]:
    ...
    for case in cases:
        ...
        elif not str(case_id).startswith(f"agent_rs_{category}_"):
